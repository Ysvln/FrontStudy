...
function productTable(searchProductName, productNumber) {
    let items = {
        야채곱창: 5,
        바나나우유: 10,
        삼각김밥: 15,
    ...
    if (items[searchProductName] === undefined)
        return console.log(searchProductName, productNumber);
    if (items[searchProductName] !== productNumber)
        return console.log('전산표와 일치하지 않습니다.');
    console.log('전산표와 일치합니다.');
}

productTable('야채곱창', 15);
